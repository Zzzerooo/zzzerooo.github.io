jQuery(document).ready(function(){
   ...
   var m1 = new Morris.Donut({
        ...
        data: [
          {label: "Running Project", value: 5},
          {label: "Deploying Project", value: 4},
          {label: "Faild without Processed", value: 2},
      
        ],
        colors: ['#428BCA','#1CAF9A','#D9534F'],
	...
	var m3 = new Morris.Donut({
        ...
        data: [
          {label: "Running VMs", value: 10},
          {label: "Suspend VMs", value: 4},
          {label: "Shutdown VMs", value: 2},
